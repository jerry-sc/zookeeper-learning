...
public class ZooKeeperMain {
    ...
    /**
     * 记录客户端支持的所有命令，注意与Zookeeper启动的参数区分开来，这些命令是用来操作Zookeeper的，而参数是用来配置启动Zookeeper的
     * 可以理解为，启动zookeeper后，对zookeeper做的相应操作，联想下我们通过在cmd或者shell操作使用的命令
     */
    static final Map<String, String> commandMap = new HashMap<String, String>();

    /**
     * 每个命令名字对应一个具体命令对象，对象中封装了对应的操作
     */
    ...
    void run() throws CliException, IOException, InterruptedException {
        if (cl.getCommand() == null) {
            ...
            try {
                // 使用JLine作为终端显示工具，该工具具备更强大功能，例如查看历史记录或者自动补全
